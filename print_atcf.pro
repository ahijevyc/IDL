pro print_atcf, atcf, atcf_file_in, best_model_track, debug=debug, origmesh=origmesh
  ...
  for itime = 0, n_elements(best_model_track.times)-1 do begin
    ...
    if (0) then begin
      dT850 = best_model_track.t850_core[itime] - best_model_track.t850_surr[itime]
      dT500 = best_model_track.t500_core[itime] - best_model_track.t500_surr[itime]
      dT200 = best_model_track.t200_core[itime] - best_model_track.t200_surr[itime]
      ddZ850200 = (best_model_track.z200_core[itime] - best_model_track.z850_core[itime]) - $
        (best_model_track.z200_surr[itime] - best_model_track.z850_surr[itime])
      rainc = best_model_track.rainc[itime]
      rainnc = best_model_track.rainnc[itime]
    endif else dT850 = 0 & dT500 = 0 & dT200 = 0 & ddZ850200 = 0 & rainc = 0 & rainnc = 0
    depth='X' ; X-unknown
    dir = 0
    speed = 0
