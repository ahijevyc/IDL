pro pretty_TC_intensity, lineplot, toplot=toplot
  ...
  if toplot eq 'mslp' then lineplot.ytitle = 'hPa'
  if toplot eq 'rmw' then lineplot.ytitle = 'n mi'
